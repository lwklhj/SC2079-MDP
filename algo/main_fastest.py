            ...
            # If the data is not an image, it is y distance travelled from IR
                ...
                match direction:
                    case 'L':
                        ...
                        movement_list_2.extend(["r0090", "f0010", "r0090", "f" + str(ideal_distance).rjust(
                            4, "0"), "f0050", "f" + str(ideal_distance).rjust(4, "0"), "r0090", "f0010"])
                        return_y_list.extend(
                            ["r0090", "f" + str(ideal_distance).rjust(4, "0"), "l0090"])
                    case 'R':
                        ...
                        # For moving directy to centre
                        movement_list_2.extend(["l0090", "f0010", "l0090", "f" + str(ideal_distance).rjust(
                            4, "0"), "f0050", "f" + str(ideal_distance).rjust(4, "0"), "l0090", "f0010"])
                        return_y_list.extend(
                            ["l0090", "f" + str(ideal_distance).rjust(4, "0"), "r0090"])
                if distance2:
