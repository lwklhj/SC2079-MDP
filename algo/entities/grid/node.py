...
class Node:
    ...
    def draw_self(self, screen):
        ...
        If its occupied by obstacles, draws it as its color
        ...
        if self.occupied:  # If current node is not permissible to the robot
            ...
            pygame.draw.rect(screen, colors.TEAL, rect)
    ...
    def draw_boundary(self, screen):
        ...
        # Draw
        pygame.draw.line(screen, colors.GREY, (left, top),
                         (left, bottom))  # Left border
        pygame.draw.line(screen, colors.GREY, (left, top),
                         (right, top))  # Top border
        pygame.draw.line(screen, colors.GREY, (right, top),
                         (right, bottom))  # Right border
        pygame.draw.line(screen, colors.GREY, (left, bottom),
                         (right, bottom))  # Bottom border
